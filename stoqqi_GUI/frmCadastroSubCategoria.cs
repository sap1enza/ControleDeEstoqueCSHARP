...
{
    public partial class frmCadastroSubCategoria : stoqqi_GUI.frmModeloDeFormularioDeCadastro
    {
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.operacao == "inserir")
                {
                    ...
                    bll.Incluir(modelo);
                    MessageBox.Show("SubCategoria: Código " + modelo.ScatCod.ToString());
                }
                else
                {
