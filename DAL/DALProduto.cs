...
namespace DAL
{
    public class DALProduto
    {
        ...
        public void Incluir(ModeloProduto obj)
        {
            ...
            cmd.CommandText = "insert into Produto (pro_nome, pro_descricao, pro_valorpago, pro_valorvenda, pro_qtde,umed_cod , cat_cod, scat_cod) "+
            "values (@nome,@descricao,@valorpago,@valorvenda,@qtde,@undmedcod,@catcod,@scatcod); select @@IDENTITY;";
        ...
        public DataTable Localizar(String valor)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("Select p.pro_cod, p.pro_nome, p.pro_descricao, p.pro_valorpago, "+
